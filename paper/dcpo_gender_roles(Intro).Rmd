...
#Introduction
Much of the comparative public opinion literature that does consider gender places its importance at the individual level. Such scholarship focuses on how men and women express significantly different opinions in various issue areas such as public policy preferences [@kellstedt2010macro], the use of military force [@brooks2011war; @eichenberg2016gender], and female political leadership [@badas2019michelle] to name a few. While such research has produced interesting and important findings by asking how gender affects public opinion, it ignores a second equally relevant piece of the puzzle that our data is better equipped to address – that is, how does public opinion affect gender? This analytical reframing is important, because without it, the literature loses sight of gender as not only a variable indicating part of an individual’s identity, but also as a macrolevel process that groups of people produce, experience, and challenge as part of their political lives. By measuring cross-national time-variant attitudes toward gender egalitarianism, our data positions researchers to ask questions about how public opinion relates to the macrolevel processes of gender.
Gender egalitarian attitudes have been grown over decades not only in developed countries but also in developing societies [@boehnke2011gender]. With the affluent variance in the gender egalitarian attitudes around the world, scholars propose innovative research questions about the influence of gender egalitarian attitudes and its determinants. For example, the association between gender egalitarian attitudes and women’s political behavior [@krauss1974political], gender inequalities [@bianchi2012housework], women’s descriptive representation in parliaments [@paxton2003women] have been examined. However, the lack of cross-national time-series index prevents us from unveiling the cause and effect of gender egalitarian attitudes. Very few cross-national time-series measures of gender egalitarianism exist and there is no consensus on the measures. Even though a gender egalitarian index developed by @mcdaniel2008measuring  exists, it only deals with limited number of countries (n=38) and with the fourth wave of World Value Survey (WVS) conducted between 1999 and 2004.
The newly developed gender egalitarian index enables scholars to evaluate the generalizability of existing theories with large-N analysis, test the cause and effect of gender egalitarian attitudes, build new theories with the preliminary statistical analysis, etc. As the very first step, the index provides an opportunity to descriptively examine how the attitudes have been changed over decades and why there are variations among countries with different political institutions, culture, religion, and other country specific factors. Also, we can test the long-lasting question suggested by @krauss1974political about whether the differences in political behavior such as protests, voting, political volunteerism, and feminist movement of men and women are attributed to biological differences or public’s views on the gender role. Moreover, the index makes it possible to unveil the relationship between gender egalitarianism and women’s mobilization and representation [@erickson2002gender; @erickson2002gender; @klein2013gender; @paxton1997women] with our index. Further, the broad time span of our index enables scholars to test causality and the direction of the relationship.
	One example of how our data might be used to investigate these macrolevel processes is researching how public opinion regarding gender roles affects the makeup of national militaries. The comparative public opinion literature has completely neglected this connection, despite scholarly interest in how public opinion affects policy decisions [@stimson1995dynamic; @lax2009gay; @Wwlezien2017public], the relationship between public opinion and political institutions [@bartels2009explaining; @grieco2011let; @nir2015institutions], and how gender affects public opinion toward military actions [@brooks2011war; @eichenberg2016gender; @lizotte2017gender]. If there exists a strong correlation between countries that largely hold traditionalist views toward gender roles and countries that exclude women from participating in the state military, then this would support a theory that national military policies tend to be congruent with public opinion. One could theorize that this is because of incentive structures military policy-makers face, and perhaps the level of congruence between public opinion and military policy is conditioned by other factors such as regime type. 
However, it would be just as interesting to discover that there is no correlation between public opinion on gender roles and women’s inclusion/exclusion from state militaries. If the countries with largely egalitarian views toward gender roles are no more likely to incorporate women into the national military than more traditionalist countries, then this would reveal important patterns in the gendered makeup of national militaries. Perhaps these typically male-dominated institutions have shifted over time from being male-dominated as a norm to being male-dominated as an active resistance to public demands for change – in which case, national militaries have developed an identity as not just masculine institutions, but as preservers of traditional masculinity. Regardless of what results might unfold from this avenue of research, using our data on attitudes toward gender egalitarianism to test theories regarding macroprocesses of gender will help move the comparative public opinion literature beyond just identifying how male and female survey respondents differ from one another.  
