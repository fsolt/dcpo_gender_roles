...
To overcome this limitation, we develop a comparable cross-national over time measure about gender egalitarian view in the public sector through the DCPO package for R [@Solt2020a]. (Quick Review of our Index can be included - number of countries and years, unit of analysis, number of surveys and questionnaires will be introduced).


The newly developed gender egalitarian index enables scholars to evaluate the generalizability of existing theories with large-N analysis, test the cause and effect of gender egalitarian attitudes, and build new theories with the preliminary statistical analysis.
...
# Below sentences are to explain four dimensions and the dimension we will concentrate (needed to be reviewed and modified)

We examine all questionnaires asking opinions about gender roles from series of cross-national surveys such as World Value Surveys (WVS) and surveys conducted in individual countries or regions.
After collecting the all questionnaires, we classify them into four categories: egalitarian gender roles in the public sector which has been generally dominated by male, those in private sector where the role of female has been emphasized, the balance of female role in private and public sector, and male dominance over women.


(How about adding some sentences or table to show what kind of questionnaires are classified into the four categories?)


Even though questionnaires in the four categories are asking about opinions about gender roles, generating a measure of egalitarian gender roles without the classification may cause multidimensionality problem since people might have different opinions about gender roles by the dimensions.
