...
In this letter, we present the Public Gender Egalitarianism (PGE) dataset, which is based on the host of survey data available and recent advances in latent variable modeling of public opinion that allow us to make use of this sparse and incomparable data.
...
load(here::here("data", "poliwork_polileader4_2_2k.rda"))
...
To provide further confirmation of the unidimensionality of public gender egalitarianism, we divided the source data described above to estimate separate indices of gender egalitarianism in politics, in the workplace, and in education.  The resulting indices all correlate very highly with the PGE scores and with each other, reinforcing the conclusion that public gender egalitarianism exists as a single dimension across countries and years; see online Appendix C.]
