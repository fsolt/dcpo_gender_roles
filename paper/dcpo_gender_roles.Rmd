...
Version 1.0 of the PGE dataset includes PGE Mean and Polarization scores for `r pge[[1]] %>% distinct(country) %>% nrow()` countries for as many years as possible from 1972 to the present, a total of `r pge[[1]] %>% nrow()` country-years.
