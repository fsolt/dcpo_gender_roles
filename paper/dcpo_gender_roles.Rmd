...
After collecting the all questionnaires, we classify them into four categories: egalitarian gender roles in the public sector which has been dominated by male, those in private sector where the role of female has been emphasized, the balance of female role in private and public sector, and male dominance over women.


(How about adding some sentences or table to show what kind of questionnaires are classified into the four categories?)


Even though questionnaires in the four categories are asking about opinions about gender roles, generating estimates about egalitarian gender roles without the classification may cause multi-dimensionality problem.
