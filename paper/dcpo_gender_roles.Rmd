...
To avoid any potential multidimensionality in the Public Gender Egalitarianism index, we include only survey items corresponding to the first category, gender egalitarianism in the public sphere.
...
```{r cs_plot, fig.cap="Egalitarian Gender Attitudes, Most Recent Available Year \\label{cs_2020}", fig.height=8, warning=FALSE}
load(here::here("data", "dcpo_input_public.rda"))
