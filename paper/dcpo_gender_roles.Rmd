...
If we disregard this kind of multi-dimensionality, we will not be able to measure gender egalitarianism properly in the various dimensions that people have.
...
However, given that there are some variations of gender

After examining all questionnaires asking opinions about gender roles from series of cross-national surveys including World Value Survey (WVS) and surveys conducted in individual countries or regions such as Arab Barometer, Korean General Social Survey, etc.,  
...
egalitarian gender roles in the public sector which has been generally dominated by male, those in private sector where the role of female has been emphasized, the balance of female role in private and public sector, and male dominance over women.
