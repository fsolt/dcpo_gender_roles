...
```{r ts_plots, fig.cap="PGE Scores Over Time, Selected Countries \\label{ts}", fig.height=3.5}
countries <- c("Norway", "Australia", "United States", "Mexico", "Taiwan",
                "Japan", "Turkey", "Nigeria", "Philippines", "Egypt")
...
Figure&nbsp;\ref{ts} shows the time series of the PGE scores for ten countries.
