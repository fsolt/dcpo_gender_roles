...
Together, these survey items were asked in `r n_countries` different countries over `r year_range`.
...
That this--again, which represents the _most common_ survey item--constitutes only `r sprintf("%2.1f", (polileader4_cy*100/total_cy))`% of the `r total_cy` total possible country-years covered underscores just how sparse the available public opinion data is on this topic.
