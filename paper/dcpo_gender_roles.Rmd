...
n_years <- as.integer(summary(dcpo_input_raw$year)[6]-summary(dcpo_input_raw$year)[1])
...
Together, these survey items were asked in `r n_countries` different countries over `r n_years` years, `r year_range`, yielding a total of `r n_cyi` country-year-item observations.
